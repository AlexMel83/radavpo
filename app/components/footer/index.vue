<template>
  <footer
    id="contacts"
    class="bg-white dark:bg-custom-black dark:text-custom-gray py-4 border-t dark:border-gray-700 border-custom-border relative"
  >
    <div class="container mx-auto px-3">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="flex flex-col justify-between">
          <h3
            class="text-lg font-space-grotesk mb-1 dark:bg-gradient-to-b dark:from-custom-gray dark:to-custom-white dark:text-transparent bg-clip-text"
          >
            {{ $t('Footer.contacts') }}
          </h3>
          ...
          <div class="flex items-center justify-between text-center text-sm gap-4 mt-4">
      ...
      <div class="text-center mt-4 pt-4 border-t border-custom-border">
        <NuxtLink
      ...
      <button
        v-if="showScrollTop"
        class="fixed bottom-6 right-6 bg-custom-orange text-custom-white w-10 h-10 rounded-full shadow-lg hover:bg-custom-border hover:scale-105 transition-all duration-300 z-50"
        title="Наверх"
        @click="scrollToTop"
      >
