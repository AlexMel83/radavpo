...
<template>
  <div class="flex flex-col items-center w-full">
    <div class="flex gap-4 max-w-md">
      <!-- Google Login Button -->
      <div
        class="flex items-center justify-center w-full px-4 py-3 bg-slate-100 dark:bg-slate-600 dark:text-white rounded-lg shadow-md hover:scale-105 hover:shadow-lg transition-transform cursor-pointer whitespace-nowrap"
